...
class TrendlineExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let chartPoints: [ChartPoint] = [(1.5, 3), (2, 5), (3, 7.5), (4, 10), (5, 6), (6, 12)].map{ChartPoint(x: ChartAxisValueDouble($0.0, labelSettings: labelSettings), y: ChartAxisValueDouble($0.1))}
